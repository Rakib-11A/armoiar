Rails.application.routes.draw do
  ...
  namespace :admin do
    ...
    get "/subscribers", to: "dashboard#subscribers"
    get "/reports", to: "dashboard#monthly_reports"
    get "/purchase_reports", to: "dashboard#purchase_reports"
    get "/sales_reports", to: "dashboard#sales_reports"
    namespace :suppliers do
      get "/purchase/orders", to: "purchase_orders#index", as: :purchases
      resources :purchase_orders do
        member do
          ...
          get :complete
          post :update_item
          post :update_receive_item
          post :update_purchase
          post :remove_item
          post :remove_receive_item
          get :receive
          post :received_purchase
        end
        collection do
          get :refunds
          get :new_order
          get :refund
          get :new_refund_items
          post :return_item
        end
      end
      ...
      resources :refunds do
        collection do
          ...
          get :refund_items
          get :edit_refund
          delete :remove_refund_item
          post :new_return_item
          post :update_refund
          delete :remove_refund
        end
      end
      resources :payments do
        get :complete, on: :member
        get :confirm, on: :member
        get :bounce, on: :member
        get :rescheduled, on: :member
        get :download, on: :collection
        get :commission_report, on: :collection
      end
